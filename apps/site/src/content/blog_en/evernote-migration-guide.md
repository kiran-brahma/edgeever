---
draft: false
title: "Guide to migrating from Evernote to Kiran Brahma Notes"
snippet: "Migrate notes you own into a self-hosted Kiran Brahma Notes instance with Kiran Brahma Notes MCP, evernote-backup, and the ENEX import script."
image: {
    src: "/images/evernote-migration.jpg",
    alt: "Migrating from Evernote to Kiran Brahma Notes"
}
...
> Kiran Brahma Notes is not affiliated with, endorsed by, or sponsored by Evernote. This guide only explains how users can migrate data they own into Kiran Brahma Notes. Evernote is a trademark of its respective owner.
...
### Step 1: Configure and install the Kiran Brahma Notes MCP service
...
```text
You are my AI coding assistant. This is my Kiran Brahma Notes MCP service configuration JSON. Please configure this MCP service directly in the MCP server configuration file for the AI editor/client I am currently using, such as Claude Code, Cursor, Cline, or a similar tool:
...
After the assistant has configured MCP, copy the prompt below and send it to the assistant so it can export your Evernote data and import it into Kiran Brahma Notes:

```text
You are my AI coding assistant. Please migrate my local Evernote data into my currently deployed Kiran Brahma Notes instance:
...
3. Download the latest migration script from GitHub: `https://raw.githubusercontent.com/kiran-brahma/edgeever/main/scripts/import-evernote-enex-via-mcp.mjs`.
...
> Manual fallback: if you do not use an AI assistant, open the [Kiran Brahma Notes GitHub repository](https://github.com/kiran-brahma/edgeever), download `scripts/import-evernote-enex-via-mcp.mjs`, and follow the instructions in the script header.

---

### Step 3: Verify the import in the web app

1. After import completes, return to the Kiran Brahma Notes web app and refresh the page.
