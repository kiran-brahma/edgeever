...
export const MobileEditorNotebookButton = ({
  ...
  <button className="mobile-editor-notebook-button" type="button" aria-label="Notebook" disabled={disabled} onClick={onOpen}>
    <span>{label}</span>
...
export const MobileEditorFallback = ({ markdown }: { markdown: string }) => (
  <details className="mobile-editor-fallback">
    <summary>View current Markdown backup</summary>
    <pre>{markdown}</pre>
  </details>
);
