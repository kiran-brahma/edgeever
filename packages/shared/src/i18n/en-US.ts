...
export const enUS = {
  ...
  login: {
    title: "Sign in to Kiran Brahma Notes",
  ...
  feedback: {
    ...
    systemInfoNotice: "The following information was generated by Kiran Brahma Notes to help diagnose the issue.",
    privacyNotice: "GitHub Issues are public. Do not include passwords, tokens, instance URLs, or private note content.",
  },
  dataExport: {
    title: "Import and export",
    description: "One archive for openness and complete recovery: read notes directly as Markdown, or use the structured data, revision history, and attachments to migrate between Kiran Brahma Notes instances.",
    exportButton: "Export Kiran Brahma Notes ZIP",
    importButton: "Import Kiran Brahma Notes ZIP",
    ...
    importComplete: "Kiran Brahma Notes ZIP imported successfully.",
    importErrors: {
      ...
      unsupportedFormat: "This archive format is not supported. Select a ZIP exported by Kiran Brahma Notes.",
      unsupportedVersion: "This Kiran Brahma Notes ZIP requires a newer version of Kiran Brahma Notes. Upgrade before importing it.",
      ...
      network: "Kiran Brahma Notes could not be reached during import. Check your connection and try again.",
      unknown: "Import failed because of an unknown error. Export a new archive and try again.",
    },
    importConfirmTitle: "Import Kiran Brahma Notes ZIP",
    importConfirmDescription: "This file contains {{memos}} notes and {{resources}} resources. Other data in this instance is preserved, but matching Kiran Brahma Notes IDs are overwritten.",
  ...
  evernoteImport: {
    ...
    description: "Review the steps for migrating from Evernote to Kiran Brahma Notes. MCP and AI Agent batch import are recommended.",
  },
  session: {
  ...
  advancedPlay: {
    ...
    prompts: {
      persona: {
        ...
        prompt: "Use Kiran Brahma Notes MCP to read my notes and create a persona profile based on the real note content. Judge only from evidence in the notes, do not make psychological diagnoses, and do not exaggerate traits. Include long-term themes, work preferences, capability signals, recurring problems, recent direction, and list related note titles or memo ids after each conclusion.",
      },
      knowledgeMap: {
        title: "Knowledge map",
        prompt: "Use Kiran Brahma Notes MCP to read my notes and organize a knowledge map. Identify the main knowledge areas, key concepts in each area, related notes, what I already understand, and the gaps I still need to fill. Structure the output so it is useful for continued learning and writing.",
      },
      tagAdvice: {
        title: "Tag suggestions",
        prompt: "Use Kiran Brahma Notes MCP to read my notes and existing tags, then design a clearer tag system. Point out duplicate, overly narrow, overly broad, or inconsistently named tags, and suggest merges, renames, and new tags. Do not modify notes yet. Wait for my confirmation before applying changes.",
      },
    },
  },
  templates: {
  ...
  pwa: {
    ...
    appliedTitle: "Kiran Brahma Notes updated",
    ...
    sidebarInstallTitle: "Install Kiran Brahma Notes Desktop App",
    iosPrompt: {
      title: "Add Kiran Brahma Notes to Home Screen",
